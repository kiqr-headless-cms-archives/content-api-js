...
export class DocumentsApi extends runtime.BaseAPI implements DocumentsApiInterface {
    ...
    async getDocumentRaw(requestParameters: GetDocumentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Document>> {
        if (requestParameters.contentTypeSlug === null || requestParameters.contentTypeSlug === undefined) {
            throw new runtime.RequiredError('contentTypeSlug','Required parameter requestParameters.contentTypeSlug was null or undefined when calling getDocument.');
        }
        ...
        if (this.configuration && this.configuration.apiKey) {
            queryParameters["environment_id"] = this.configuration.apiKey("environment_id"); // environmentId authentication
        }

        const response = await this.request({
            path: `/{content_type_slug}/{document_slug}`.replace(`{${"content_type_slug"}}`, encodeURIComponent(String(requestParameters.contentTypeSlug))).replace(`{${"document_slug"}}`, encodeURIComponent(String(requestParameters.documentSlug))),
            method: 'GET',
    ...
    async getDocumentsRaw(requestParameters: GetDocumentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DocumentsCollection>> {
        if (requestParameters.contentTypeSlug === null || requestParameters.contentTypeSlug === undefined) {
            throw new runtime.RequiredError('contentTypeSlug','Required parameter requestParameters.contentTypeSlug was null or undefined when calling getDocuments.');
        }
        ...
        const response = await this.request({
            path: `/{content_type_slug}/`.replace(`{${"content_type_slug"}}`, encodeURIComponent(String(requestParameters.contentTypeSlug))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
